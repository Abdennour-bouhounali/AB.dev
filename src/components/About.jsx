        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start md:items-center">
          ...
          <ScrollReveal direction="right" className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
              <div className="bg-surface-card border border-white/8 dark:border-white/8 light:border-zinc-200 p-5 sm:p-6 rounded-md hover:border-white/15 dark:hover:border-white/15 light:hover:border-zinc-300 hover:bg-surface-card-hover transition-colors duration-200">
                <div className="w-9 h-9 bg-accent-purple/12 rounded-sm flex items-center justify-center mb-4">
                  <Zap className="w-4 h-4 text-accent-purple" />
                </div>
                <h3 className="font-heading font-semibold text-zinc-900 dark:text-white text-xs sm:text-sm mb-2">
                  {t("about.pillar1Title")}
                </h3>
                <p className="text-zinc-500 dark:text-zinc-400 text-[10px] sm:text-[11px] leading-relaxed">
                  {t("about.pillar1Desc")}
                </p>
              </div>
              <div className="bg-surface-card border border-white/8 dark:border-white/8 light:border-zinc-200 p-5 sm:p-6 rounded-md hover:border-white/15 dark:hover:border-white/15 light:hover:border-zinc-300 hover:bg-surface-card-hover transition-colors duration-200">
